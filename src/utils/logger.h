...
#define LOG_TRACE(msg) ::openspectrum::Logger::get_instance().log( \
    ::openspectrum::LogLevel::TRACE, __FILE__, __LINE__, __func__, msg)

#define LOG_DEBUG(msg) ::openspectrum::Logger::get_instance().log( \
    ::openspectrum::LogLevel::DEBUG, __FILE__, __LINE__, __func__, msg)

#define LOG_INFO(msg) ::openspectrum::Logger::get_instance().log( \
    ::openspectrum::LogLevel::INFO, __FILE__, __LINE__, __func__, msg)

#define LOG_WARNING(msg) ::openspectrum::Logger::get_instance().log( \
    ::openspectrum::LogLevel::WARNING, __FILE__, __LINE__, __func__, msg)

#define LOG_ERROR(msg) ::openspectrum::Logger::get_instance().log( \
    ::openspectrum::LogLevel::ERROR, __FILE__, __LINE__, __func__, msg)

#define LOG_CRITICAL(msg) ::openspectrum::Logger::get_instance().log( \
...
#define LOGS_TRACE ::openspectrum::LogStream(::openspectrum::LogLevel::TRACE, __FILE__, __LINE__, __func__)
#define LOGS_DEBUG ::openspectrum::LogStream(::openspectrum::LogLevel::DEBUG, __FILE__, __LINE__, __func__)
#define LOGS_INFO ::openspectrum::LogStream(::openspectrum::LogLevel::INFO, __FILE__, __LINE__, __func__)
#define LOGS_WARNING ::openspectrum::LogStream(::openspectrum::LogLevel::WARNING, __FILE__, __LINE__, __func__)
#define LOGS_ERROR ::openspectrum::LogStream(::openspectrum::LogLevel::ERROR, __FILE__, __LINE__, __func__)
#define LOGS_CRITICAL ::openspectrum::LogStream(::openspectrum::LogLevel::CRITICAL, __FILE__, __LINE__, __func__)
