...
# All source files
ALL_SRCS := $(HARDWARE_SRCS) $(SIGNAL_SRCS) $(FFT_SRCS) $(VIS_SRCS) $(UTILS_SRCS) $(MAIN_SRC)
...
# Final target
$(TARGET): $(HARDWARE_OBJS) $(SIGNAL_OBJS) $(FFT_OBJS) $(VIS_OBJS) $(UTILS_OBJS) $(KISSFFT_OBJS) $(MAIN_OBJ)
	$(CXX) $^ -o $@ $(LDFLAGS)
